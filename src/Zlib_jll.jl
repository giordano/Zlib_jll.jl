...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Zlib_jll on Julia versions older than 1.3!")
end
...
const artifacts_toml = get_artifacts_toml(@__DIR__)

# Extract all platforms
const artifacts = get_artifacts(artifacts_toml, UUID("83775a58-1f1d-513f-b197-d71354ab007a"))
const platforms = get_platforms("Zlib", artifacts_toml, artifacts)
...
if best_platform === nothing
    @debug("Unable to load Zlib; unsupported platform $(triplet(platform_key_abi()))")
else
